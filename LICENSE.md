...
memorize_hub is **fair-code** distributed software
(see [faircode.io](https://faircode.io)): the source is open, anyone may use,
modify, and self-host it, and only one thing is reserved to the author —
selling it to third parties as a hosted/managed service.

- All source in this repository is available under the **Sustainable Use
  License** (Version 1.0), reproduced in full below.
- Third-party components incorporated into this software are licensed under the
  original license provided by the owner of the applicable component.

In plain terms, under this license you **may**:

- run and self-host memorize_hub for your own internal business, non-commercial,
  or personal use, on any infrastructure you control;
- modify it and create derivative works;
- distribute it to others, free of charge, for non-commercial purposes.

You **may not**, without a separate commercial license from the author:

- offer memorize_hub (or a derivative) to third parties as a hosted or managed
  service, or otherwise white-label or resell it.
